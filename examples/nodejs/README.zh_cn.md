...
本目录包含 JinWo VecDB 的 Node.js 示例，演示如何使用 Node.js 和 ffi-napi 调用 C API 来使用向量数据库。
...
- 对于 macOS: `libjw_vecdb.dylib` 在 `../../build/`
...
- 使用 ffi-napi 库调用 C API
- 封装 C API，提供 Node.js 可调用的接口
