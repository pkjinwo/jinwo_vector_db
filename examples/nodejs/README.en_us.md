...
This directory contains a Node.js example for JinWo VecDB, demonstrating how to use Node.js and ffi-napi to call the C API for the vector database.
...
- For macOS: `libjw_vecdb.dylib` in `../../build/`
...
The Node.js example demonstrates the following features:
...
- Uses ffi-napi library to call C API
- Wraps C API, provides Node.js-callable interface
